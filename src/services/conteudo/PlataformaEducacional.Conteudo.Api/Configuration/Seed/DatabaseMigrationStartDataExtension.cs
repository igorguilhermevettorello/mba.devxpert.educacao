...
namespace PlataformaEducacional.Conteudo.Api.Configuration.Seed
{
    public static class DatabaseMigrationStartDataExtension
    {
        ...
        private static async Task EnsureSeedCursos(CursoContext context)
        {
            ...
            AddCursoFundamentosCSharp(cursos);
            AddCursoWebApi(cursos);
            AddCursoCleanArchitecture(cursos);
            AddCursoSql(cursos);
            AddCursoTestesAutomatizados(cursos);
        ...
        private static void AddCursoTestesAutomatizados(List<Curso> cursos)
        {
            var curseTestes = new Curso(
                            SeedConteudo.CURSO_TESTES_AUTOMATIZADOS_ID,
        ...
        private static void AddCursoSql(List<Curso> cursos)
        {
            var cursoBD = new Curso(
                SeedConteudo.CURSO_SQL_ID,
        ...
        private static void AddCursoCleanArchitecture(List<Curso> cursos)
        {
            var cursoCleanArch = new Curso(
                            SeedConteudo.CURSO_CLEAN_ARCHITECTURE_ID,
        ...
        private static void AddCursoWebApi(List<Curso> cursos)
        {
            var cursoWebApi = new Curso(
                            SeedConteudo.CURSO_WEB_API_ID,
        ...
        private static void AddCursoFundamentosCSharp(List<Curso> cursos)
        {
            var cursoCSharp = new Curso(
                            SeedConteudo.CURSO_FUNDAMENTOS_CSHARP_ID,
